...
//crie as variáveis para o fim de jogo e som de corte da faca
...
function preload(){
  ...
  //carregue o som de fim de jogo e de corte nas variáveis
  ...
  if(gameState===PLAY){
    ...
    else
    {
      ...
      if(monsterGroup.isTouching(knife)){
        gameState=END;
        //toque o som de fim de jogo/gameover
